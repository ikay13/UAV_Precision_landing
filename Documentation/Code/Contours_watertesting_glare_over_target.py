...
image_path = 'Documentation/Images/finished/watertesting/helipad_w_glare_notext_og.png'
...
processed_image = cv2.imread('Documentation/Images/finished/watertesting/helipad_w_glare_notext_thr.png', cv2.IMREAD_GRAYSCALE)
...
for c in contour:
    ...
    #c = c + np.array([42, -12])
    approx_temp = cv2.approxPolyDP(c, 0.03*cv2.arcLength(c, True), True)
    #Draw the contour
...
plt.savefig('Documentation/Images/finished/watertesting/helipad_w_glare_notext_contours.png', bbox_inches='tight')
